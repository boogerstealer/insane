...
module.exports = class extends BaseCommand {
    ...
    async run(client, message, args) {
        if (message.flags.includes('interactive')) {
            ...
            if (!channel.permissionsFor(message.guild.me).has(['SEND_MESSAGES', 'MANAGE_CHANNELS', 'VIEW_CHANNEL'])) return message.channel.send('Tadu doesn\'t have permissions to that channel, please give Tadu access to that channel for this to work and try again...Exiting Setup');
